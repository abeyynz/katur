{{-- <x-app-layout>
    <div class="max-w-xl mx-auto mt-20 bg-white p-6 rounded shadow">
        <h2 class="text-xl font-bold text-blue-800 mb-4">Buat Postingan Kegiatan</h2>
        ...
        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="caption" class="block font-medium text-blue-700">Caption</label>
                <textarea name="caption" id="caption" rows="3"
                    class="w-full border border-yellow-400 rounded p-2 focus:ring-2 focus:ring-yellow-300 focus:outline-none">{{ old('caption') }}</textarea>
            </div>

            <div class="mb-4">
                <label for="image" class="block font-medium text-blue-700">Upload Gambar</label>
                <input type="file" name="image" id="image"
                    class="w-full border border-yellow-400 rounded p-2 focus:ring-2 focus:ring-yellow-300 focus:outline-none">
            </div>
